            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
							...
							<li class="breadcrumb-item active">edit book a bottle</li>
                        </ol>
                    </div>
				...
				<div class="row b-b">
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 p-r0 text-left m-b0">
						...
						<h4 class="card-title m-b20 flt-left p-t5 p-l20 ">Edit Book A Bottle</h4>
					</div>
												...
												<div class="row">
													<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
														<div class="form-group">
															...
															<input type="text" id="bottleName" class="form-control" placeholder="Bottle Name">
															<small class="form-control-feedback"></small> 
														</div>
													</div>
