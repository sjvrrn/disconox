...
{
?>
<input type="hidden" name="price" id="price" value="<?php echo $expldTickets[1]; ?>">
                  <div class="panel">
                    ...
                    <div id="collapseTwo2" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo" aria-expanded="false" style="">
                      ...
                      <div class="panel-body">
                        ...
                        <div class="col-md-9 col-xs-12">
                          <p class="lit-info2">
                            <label class="checkbox-inline">Actual Price:<strike> Rs. <?php echo $expldTickets[0]; ?>/-</strike></label>
                          </p>
                          <hr>
                          <p class="lit-info2">
                            <label class="checkbox-inline">Price: Rs. <?php echo $expldTickets[1]; ?>/-</label>
