<?php 
require_once("../partners/create-edit-surprise.php"); exit;
?>
        ...
        <div class="container-fluid">
            ...
            <div class="row page-titles">
                <div class="col-md-5 col-8 align-self-center">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">edit Surprise</li>
                    </ol>
                </div>
            ...
            <div class="row b-b">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 p-r0 text-left m-b0">
                    ...
                    <h4 class="card-title m-b20 flt-left p-t5 p-l20 ">Edit Surprise</h4>
                </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" id="firstName" class="form-control" placeholder="2500/-">
                                                                    <small class="form-control-feedback"></small>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label class="control-label">Note</label>
                                                                    <input type="text" id="firstName" class="form-control" placeholder="To avail offer, Minimum 24 hours prior">
                                                                    <small class="form-control-feedback"></small>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
