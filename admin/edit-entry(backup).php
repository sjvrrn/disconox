            ...
            <div class="container-fluid">
				...
				<div class="row b-b">
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 p-r0 text-left m-b0">
						...
						<h4 class="card-title m-b20 flt-left p-t5 p-l20 ">Edit Entry</h4>
					</div>
									...
									<div class="row">
										<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
											<div class="form-group">
												...
												<input type="text" id="firstName" class="form-control" placeholder="Event Name">
										...
										<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
											<div class="form-group">
												...
												<input type="text" id="firstName" class="form-control" placeholder="Venue Address">
												<small class="form-control-feedback"></small> 
											</div>
                                        </div>
										<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
												...
												<div class="row">
													<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
														<div class="form-group">
															...
															<input type="text" id="bottleName" class="form-control" placeholder="Ex: Couple">
															<small class="form-control-feedback"></small> 
														</div>
													</div>
													<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
														<div class="form-group">
															...
															<input type="text" id="offer-price" class="form-control" placeholder="Ex: 2500/-">
															<small class="form-control-feedback"></small> 
														</div>
													</div>
													<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
														<div class="form-group">
															...
															<input type="text" id="offer-price" class="form-control" placeholder="Ticket Name">
															<small class="form-control-feedback"></small> 
														</div>
													</div>
												</div>
