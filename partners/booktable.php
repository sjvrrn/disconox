...
foreach($products as $product){
	...
	$image = $product->image;
	$booktable .='<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
						<div class="card card-outline-info m-t20">
							<div class="card-body partner">
								<div class="card-top" style="background:url('.$product->image.') no-repeat; width:100%; height:192px;">
									...
									<div class="pull-right"><a  id="delete" href="book-table.php?dt='.base64_encode($product->productid).'"   class="fatrash"><i class="fa fa-trash-o"></i></a></div>
									<div class="post-title"><i class="fa fa-flag p-r5"></i>Book A Table</div>
								</div>
                                <div class="card-middle">
									...
									<div class="text-right"><a href="book-table.php?et='.base64_encode($product->productid).'"><button type="button" class="btn waves-effect waves-light btn-rounded btn-success">EDIT</button></a></div>
                    ...
                    <div class="col-lg-12">
						...
						<div class="row b-b">
							<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 xsp-l10">
							 <h4 class="card-title m-b0">Book A Table</h4>
							</div>
							<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 p-r0 text-right p-b10">
                            	<a href="book-table.php"><button type="button" class="btn waves-effect waves-light btn-rounded btn-success">+ Create New</button></a>
								<!--<a href="#"><button type="button" class="btn waves-effect waves-ligp.ht btn-rounded btn-info">Back</button></a>-->
							</div>
						...
						<div class="card card-outline-info m-t20">
							<div class="card-body partner">
                                ...
                                <div class="card-middle">
									...
									<div class="text-right"><a href="create-edit-book-table.php"><button type="button" class="btn waves-effect waves-light btn-rounded btn-success">EDIT</button></a></div>
									<div class="clearfix"></div>
								</div>
							</div>
						</div>
                ...
                <div class="bg-borange">
                	<div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <a href="book-table.php"><button type="button" class="btn waves-effect waves-light btn-rounded btn-info flt-right">Create New Post</button></a>
                        </div>
                    </div>
                </div>
