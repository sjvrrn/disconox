	...
	$packages .='<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
						<div class="card card-outline-info m-t20">
							...
							<div class="card-top" style="background:url('.$product->image.') no-repeat; width:100%; height:192px;">
									...
									<div class="pull-right"><a  id="delete" href="edit-entry.php?dp='.base64_encode($product->productid).'"   class="fatrash"><i class="fa fa-trash-o"></i></a></div>
									<div class="post-title"><i class="fa fa-flag p-r5"></i>Entry</div>
								</div>
                                <div class="card-middle">
									...
									<div class="text-right"><a href="edit-entry.php?ee='.base64_encode($product->productid).'"><button type="button" class="btn waves-effect waves-light btn-rounded btn-success">EDIT</button></a></div>
                    ...
                    <div class="col-lg-12">
						...
						<div class="row b-b">
							...
							<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 p-r0 text-right p-b10">
                            	<a href="edit-entry.php"><button type="button" class="btn waves-effect waves-light btn-rounded btn-success">+ Create New</button></a>
                ...
                <div class="bg-borange">
                	<div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <a href="edit-entry.php"><button type="button" class="btn waves-effect waves-light btn-rounded btn-info flt-right">Create New Post</button></a>
                        </div>
                    </div>
