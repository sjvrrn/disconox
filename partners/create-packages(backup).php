 ...
 /*getDetals & offers start*/
  ...
  if(isset($_POST['submit'])){	
	  ...
	  /*end**/
		 ...
		 *book package start
		 */
		$_POST['start_time'] = "12:07:00 00";
		$_POST['end_time'] = "02:07:00 00";
		$_POST['booking_days'] = array('1','2');
                          ...
                          <div class="tab-pane" id="tab2" role="tabpanel">
                            <div class="p-20">
                              <div class="row">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
                                  <label class="control-label">Time Duration</label>
                                  <input  type="text" class="form-control" id="endTimeTextBox7" name="platinum_time" placeholder="Check time" value="<?php echo $platinum->duration;?>">
                                  </div>
                                
								<div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
                                  <div class="form-group">
                                    <label class="control-label">Capacity</label>
                                    <input type="text" name="platinum_capacity" class="form-control" placeholder="EX: Boys 2 : Girls 1" value="<?php echo $platinum->capacity;?>">
                                    <small class="form-control-feedback"></small> </div>
                                </div>
