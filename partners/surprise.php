...
if ($response === false) {
    ...
    if ($responsObj["error"]) {
        ...
        $products = (object)$responsObj['productDetails'];
		
    }
}
curl_close($ch);
/*end*/
foreach($products as $product){ //echo"<pre>"; print_r($product); exit;
	$product = (object)$product;
	$image = $product->image;
	//if(file_exists("admin/".$image)){$url = "admin/".$image;}else{ $url = "partners/".$image;}
	$surprises .='<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
						<div class="card card-outline-info m-t20">
							<div class="card-body partner">
								<div class="card-top" style="background:url('.$product->image.') no-repeat; width:100%; height:192px;">
									...
									<div class="pull-right"><a  id="delete" href="create-edit-surprise.php?dp='.base64_encode($product->productid).'"   class="fatrash"><i class="fa fa-trash-o"></i></a></div>
									<div class="post-title"><i class="fa fa-flag p-r5"></i>Surprise</div>
								</div>
                                <div class="card-middle">
									...
									<div class="text-right"><a href="create-edit-surprise.php?es='.base64_encode($product->productid).'"><button type="button" class="btn waves-effect waves-light btn-rounded btn-success">EDIT</button></a></div>
    ...
    <div class="container-fluid">
      <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Surprise</li>
          </ol>
        </div>
        ...
        <div class="col-lg-12">
          <div class="row b-b">
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 xsp-l10">
              <h4 class="card-title m-b0">Surprise</h4>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 p-r0 text-right p-b10"> <a href="create-edit-surprise.php">
      ...
      <div class="bg-borange">
        <div class="row">
          ...
          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12"> <a href="create-edit-surprise.php">
...
if(confirm("would like to delete")){
	return true;
	}else{
		return false;
		}
