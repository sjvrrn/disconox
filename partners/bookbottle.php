						...
						<div class="card card-outline-info m-t20">
							<div class="card-body partner">
								<div class="card-top" style="background:url('.$deal->image.') no-repeat; width:100%; height:192px;">
									...
									<div class="pull-right"><a href="book-bottle.php?dp='.base64_encode($deal->productid).'" id="delete" class="fatrash"><i class="fa fa-trash-o"></i></a></div>
									<div class="post-title"><i class="fa fa-flag p-r5"></i>Book Bottle</div>
								</div>
                                <div class="card-middle">
                                	<div class="entry-name p-b10">'.$deal->name.'</div>
									<div class="switch flt-left m-t2">
                                        <label>
                                            <input type="checkbox"  id="status"  value='.$deal->id.'><span class="lever switch-col-amber m-l0"></span>
										</label>
                                    </div>
									<div class="text-right"><a href="book-bottle.php?eb='.base64_encode($deal->productid).'"><button type="button" class="btn waves-effect waves-light btn-rounded btn-success">EDIT</button></a></div>
...
<div id="main-wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class="col-md-5 col-8 align-self-center">
            ...
            <li class="breadcrumb-item active">Book Bottle</li>
          </ol>
                </div>
        ...
        <div class="col-lg-12">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 xsp-l10">
                      <h4 class="card-title m-b0">Book Bottle</h4>
                    </div>
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 p-r0 text-right p-b10"> <a href="book-bottle.php">
        ...
        <div class="row">
            ...
            <div>At This movement you dont have any posts</div>
                  ...
                  <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12"> <a href="book-bottle.php">
