...
//	print_r($_SESSION); exit;
		...
		if ($response === false) {
            ...
            if ($responsObj["error"]) {
                ...
                $images = array_unique(explode(',',$user->images)); 
				$videos_list = array_unique(explode(',',$user->videos));
		       $imageids = array_unique($user->imageids);	//print_r($imageids); exit;
			   $videoids = array_unique($user->videoids); 
   ...
   */   $product_gallery  = array("images"=>implode(",",$gallery),"type"=>2);
	 $product_videos   = array(implode(",",$_POST['video']));  
		if($_POST['profile_id']!=""){
			 ...
			 $product_gallery  = array("images"=>implode(",",$gallery),"ids"=>$imageids);//print_r($product_gallery); exit;
...
$(document).ready(function(){
	$("#partner_image").click(function(e){
        ...
        url: "imageupload/index.php" + '?type=ajax', success: function (data) {
			...
			// $('#change-profile-pic').trigger("click");    
                            ...
                            <div class="card-body">
                                <form action="" method="post" enctype="multipart/form-data">
									...
									<div class="row">
										<div class="col-md-6">                                             
										   ...
										   if($user->partner_pic!=""){ $image= $user->partner_pic;}else{ $image= "assets/images/background/user-info.jpg";}?>
											<div class="flt-left" id="profile_image" ><img src="<?php echo $image;?>" width="100px;"/></div>
                                            <div class="revenue-fa flt-left p-t34 p-l20">
									...
									<div class="row gallery">
										...
										<?php 
										if(count($videos_list)>0&&$videos_list[0]!=""){
