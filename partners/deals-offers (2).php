<?php
require_once("../admin/edit-deals-offers.php"); exit;
?>
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
							...
							<li class="breadcrumb-item active">New/edit deals & offers</li>
                        </ol>
                    </div>
				...
				<div class="row b-b">
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 p-r0 text-left m-b0">
						...
						<h4 class="card-title m-b20 flt-left p-t5 p-l20 ">New/Edit Deals & Offers</h4>
					</div>
								...
								<form action="#">
									...
									<div class="row">
												...
												<div class="row">
													...
													<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
														<div class="form-group">
															...
															<input type="text" id="highlite-text" class="form-control" placeholder="Ex: 50% Off, Next 1 Hour">
															<small class="form-control-feedback"></small> 
														</div>
													</div>
													<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
														<div class="form-group">
															...
															<input type="text" id="minimum-booking-amount" class="form-control" placeholder="1000/-">
															<small class="form-control-feedback"></small> 
														</div>
													</div>
										...
										<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                                            <div class="form-group">
												...
												<input class="form-control" id="timepicker1" placeholder="Check time">
												<small class="form-control-feedback"></small> 
											</div>
										</div>
												</div>
										<div class="row">
											<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
												...
												<div class="input-group m-b-30"> <span class="input-group-addon">Tags</span>
													<input type="text" value="Bar,Dining,Pub" data-role="tagsinput" placeholder="add tags"> 
												</div>
											</div>
											<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
												<div class="form-group">
                                            ...
                                            <a href="#"><button type="button" class="btn waves-effect waves-light btn-rounded btn-success flt-right">+ Add More Deals</button></a>
										</div>
									...
									<div class="row">
										...
										<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                                            <div class="form-group">
												<label class="control-label">Start Time</label>
												<input class="form-control" id="timepicker2" placeholder="Check time" data-dtp="dtp_oTIiZ">
												<small class="form-control-feedback"></small> 
											</div>
										</div>
										<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                                            <label class="control-label">End date</label>
                                            <div class="input-group">
                                                <input type="text" class="form-control" id="datepicker-autoclose4" placeholder="mm/dd/yyyy">
                                            </div>
										</div>
										<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                                            <div class="form-group">
												<label class="control-label">End Time</label>
												<input class="form-control" id="timepicker3" placeholder="Check time" data-dtp="dtp_oTIiZ">
												<small class="form-control-feedback"></small> 
											</div>
										</div>
												</div>
                                    ...
                                    <a href="#"><button type="button" class="btn waves-effect waves-light btn-rounded btn-success flt-right m-t10">+ Add More Deals</button></a>
